...
DROP TYPE IF EXISTS public.classification;

CREATE TABLE public.classification (
classification_id INT GENERATED BY DEFAULT AS IDENTITY,
classification_name CHARACTER VARYING NOT NULL,
CONSTRAINT classificacion_pk PRIMARY KEY (classification_id)
);

DROP TYPE IF EXISTS public.inventory;
...
ALTER TABLE IF EXISTS public.inventory OWNER to cse340;
...
DROP TYPE IF EXISTS public.comments;

CREATE TABLE public.comments (
 comment_id INT GENERATED BY DEFAULT AS IDENTITY,
 comment_text text NOT NULL,
 comment_date timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 account_id  numeric(9, 0) NOT NULL, 
 inv_id  numeric(9, 0) NOT NULL, 
